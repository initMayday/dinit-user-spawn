...
## Installation
Choose your ideal source, and then run dinitctl enable dinit-user-spawn to enable the program. The included service file can be seen by inspecting dinit-user-spawn.service.
Note that the -git branches are not stable - releases are specified by tags.
